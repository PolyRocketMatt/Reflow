...
import com.github.polyrocketmatt.restruct.Restruct;
import com.github.polyrocketmatt.restruct.gui.icon.FlowCloseIcon;
...
public class FlowInterfaceManager {
    ...
    public FlowInterfaceManager() {
        //  Look and feel
        try {
            UIManager.setLookAndFeel(Restruct.DARK_THEME ? new FlatDarkLaf() : new FlatLightLaf());
